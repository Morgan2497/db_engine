...
func TestKVBasic(t *testing.T) {
	t.Log("=== 0203 KV lifecycle test start (Set delegates to SetEx ModeUpsert) ===")
	...
	t.Log("=== 0203 KV lifecycle test end ===")
}

func TestKVUpdateMode(t *testing.T) {
	t.Log("=== 0203 SetEx UpdateMode test start ===")
	...
	t.Log("=== 0203 SetEx UpdateMode test end ===")
}

func TestSetExModesRecoverFromLog(t *testing.T) {
	t.Log("=== 0203 SetEx modes survive crash/replay test start ===")
	...
	t.Log("=== 0203 SetEx modes survive crash/replay test end ===")
}

func TestEntryEncodeDecode(t *testing.T) {
	t.Log("=== 0203 Entry serialization test start (13-byte header: CRC + fields) ===")
	...
	t.Log("=== 0203 Entry serialization test end ===")
}

func TestEntryTombstone(t *testing.T) {
	t.Log("=== 0203 Entry tombstone test start ===")
	...
	t.Log("=== 0203 Entry tombstone test end ===")
}

func TestKVRecovery(t *testing.T) {
	t.Log("=== 0203 KV recovery test start (CRC-verified replay) ===")
	...
	t.Log("=== 0203 KV recovery test end ===")
}

func TestEmptyLogOpen(t *testing.T) {
	t.Log("=== 0203 empty log test start ===")
...
func TestEntryCRCRoundtrip(t *testing.T) {
	t.Log("=== 0203 CRC roundtrip test start ===")
	...
	t.Log("=== 0203 CRC roundtrip test end ===")
}

func TestBadChecksum(t *testing.T) {
	t.Log("=== 0203 bad checksum test start ===")
	...
	t.Log("=== 0203 bad checksum test end ===")
}

func TestTornWriteRecovery(t *testing.T) {
	t.Log("=== 0203 torn write recovery test start ===")
	...
	t.Log("=== 0203 torn write recovery test end ===")
}
