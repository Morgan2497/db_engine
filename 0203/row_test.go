...
func TestRowEncode(t *testing.T) {
	t.Log("=== 0203 Row Encode/Decode test start ===")
	...
	t.Log("=== 0203 Row Encode/Decode test end ===")
}

func TestNewRow(t *testing.T) {
	t.Log("=== 0203 NewRow test start ===")
	...
	t.Log("=== 0203 NewRow test end ===")
}

func TestDecodeKeyTooShort(t *testing.T) {
	t.Log("=== 0203 DecodeKey too-short prefix test start ===")
	...
	t.Log("=== 0203 DecodeKey too-short prefix test end ===")
}

func TestTablePrefixIsolation(t *testing.T) {
	t.Log("=== 0203 table prefix isolation test start ===")
	...
	t.Log("=== 0203 table prefix isolation test end ===")
}

func TestRowRoundtripViaEncodeOutput(t *testing.T) {
	t.Log("=== 0203 roundtrip using EncodeKey/EncodeVal output (not hand-built bytes) ===")
	...
	assert.Equal(t, row, decoded)
	t.Log("=== 0203 roundtrip via encode output test end ===")
}
