...
func TestCellI64Roundtrip(t *testing.T) {
	t.Log("=== 0202 Cell I64 roundtrip test start ===")
	...
	t.Log("=== 0202 Cell I64 roundtrip test end ===")
}

func TestCellStrRoundtrip(t *testing.T) {
	t.Log("=== 0202 Cell Str roundtrip test start ===")
	...
	t.Log("=== 0202 Cell Str roundtrip test end ===")
}

func TestCellChainedDecode(t *testing.T) {
	t.Log("=== 0202 chained cell decode test start ===")
	...
	t.Log("=== 0202 chained cell decode test end ===")
}

func TestCellEncodeAppend(t *testing.T) {
	t.Log("=== 0202 encode append (toAppend) test start ===")
	...
	t.Log("=== 0202 encode append test end ===")
}
