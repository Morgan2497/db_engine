...
func TestKVBasic(t *testing.T) {
	...
	t.Log("=== 0105 KV lifecycle test end ===")
}

func TestEntryEncodeDecode(t *testing.T) {
	t.Log("=== 0105 Entry serialization test start (13-byte header: CRC + fields) ===")
	...
	t.Log("=== 0105 Entry serialization test end ===")
}

func TestEntryTombstone(t *testing.T) {
	t.Log("=== 0105 Entry tombstone test start ===")
	...
	t.Log("=== 0105 Entry tombstone test end ===")
}

func TestKVRecovery(t *testing.T) {
	t.Log("=== 0105 KV recovery test start (CRC-verified replay) ===")
	...
	t.Log("=== 0105 KV recovery test end ===")
}

func TestEmptyLogOpen(t *testing.T) {
	t.Log("=== 0105 empty log test start ===")
...
func TestEntryCRCRoundtrip(t *testing.T) {
	t.Log("=== 0105 CRC roundtrip test start ===")
	...
	t.Log("=== 0105 CRC roundtrip test end ===")
}

func TestBadChecksum(t *testing.T) {
	t.Log("=== 0105 bad checksum test start ===")
	...
	t.Log("=== 0105 bad checksum test end ===")
}

func TestTornWriteRecovery(t *testing.T) {
	t.Log("=== 0105 torn write recovery test start ===")
	...
	t.Log("=== 0105 torn write recovery test end ===")
}
