...
func TestRowEncode(t *testing.T) {
	t.Log("=== 0204 Row Encode/Decode test start ===")
	...
	t.Log("=== 0204 Row Encode/Decode test end ===")
}

func TestNewRow(t *testing.T) {
	t.Log("=== 0204 NewRow test start ===")
	...
	t.Log("=== 0204 NewRow test end ===")
}

func TestDecodeKeyTooShort(t *testing.T) {
	t.Log("=== 0204 DecodeKey too-short prefix test start ===")
	...
	t.Log("=== 0204 DecodeKey too-short prefix test end ===")
}

func TestTablePrefixIsolation(t *testing.T) {
	t.Log("=== 0204 table prefix isolation test start ===")
	...
	t.Log("=== 0204 table prefix isolation test end ===")
}

func TestRowRoundtripViaEncodeOutput(t *testing.T) {
	t.Log("=== 0204 roundtrip using EncodeKey/EncodeVal output (not hand-built bytes) ===")
	...
	assert.Equal(t, row, decoded)
	t.Log("=== 0204 roundtrip via encode output test end ===")
}
