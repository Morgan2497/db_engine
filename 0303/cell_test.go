...
func TestCellI64Roundtrip(t *testing.T) {
	t.Log("=== 0303 Cell I64 roundtrip test start ===")
	...
	t.Log("=== 0303 Cell I64 roundtrip test end ===")
}

func TestCellStrRoundtrip(t *testing.T) {
	t.Log("=== 0303 Cell Str roundtrip test start ===")
	...
	t.Log("=== 0303 Cell Str roundtrip test end ===")
}

func TestCellChainedDecode(t *testing.T) {
	t.Log("=== 0303 chained cell decode test start ===")
	...
	t.Log("=== 0303 chained cell decode test end ===")
}

func TestCellEncodeAppend(t *testing.T) {
	t.Log("=== 0303 encode append (toAppend) test start ===")
	...
	t.Log("=== 0303 encode append test end ===")
}
