...
func TestKVBasic(t *testing.T) {
	t.Log("=== 0305 KV lifecycle test start ===")
	...
	t.Log("=== 0305 KV lifecycle test end ===")
}

func TestEntryEncodeDecode(t *testing.T) {
	t.Log("=== 0305 Entry serialization test start ===")
	...
	t.Log("=== 0305 Entry serialization test end ===")
}

func TestEntryTombstone(t *testing.T) {
	t.Log("=== 0305 Entry tombstone test start ===")
	...
	t.Log("=== 0305 Entry tombstone test end ===")
}

func TestKVRecovery(t *testing.T) {
	t.Log("=== 0305 KV recovery test start ===")
	...
	t.Log("=== 0305 KV recovery test end ===")
}

func TestEmptyLogOpen(t *testing.T) {
	t.Log("=== 0305 empty log open test start ===")
	...
	t.Log("=== 0305 empty log open test end ===")
}
...
func TestEntryCRCRoundtrip(t *testing.T) {
	t.Log("=== 0305 Entry CRC roundtrip test start ===")
	...
	t.Log("=== 0305 Entry CRC roundtrip test end ===")
}

func TestBadChecksum(t *testing.T) {
	t.Log("=== 0305 bad checksum test start ===")
	...
	t.Log("=== 0305 bad checksum test end ===")
}

func TestTornWriteRecovery(t *testing.T) {
	t.Log("=== 0305 torn write recovery test start ===")
	...
	t.Log("=== 0305 torn write recovery test end ===")
}
